...
function Stat({ title, icon, value, color }) {
  ...
  return (
    <div className="col-span-1 grid grid-rows-2 grid-cols-[6.4rem_1fr] bg-secondary-0 m-4 p-4 rounded-lg gap-x-4">
      <div
      ...
      <p className="text-3xl font-bold text-secondary-900">{toPersianNumberWithcomma(value)}</p>
    </div>
  );
}
export default Stat;