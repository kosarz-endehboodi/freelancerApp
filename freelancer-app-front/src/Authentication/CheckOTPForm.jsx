...
export default function checkOTP({ phoneNumber, onBack, onResendOtp, otpResponse }) {
    ...
    return (
        <div className="">
            ...
            <div className="flex items-center gap-x-2 my-4 pt-2">
                {otpResponse && <p>{otpResponse?.message}
                    <span>
                        <button onClick={onBack} ><CiEdit className="w-6 h-6 text-secondary-900" /></button>
                    </span>
                </p>}
            </div>
